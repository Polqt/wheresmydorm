...
import { inquiryStatusEnum, reportReasonEnum, reportStatusEnum } from "./config";
...
export const inquiryStatuses = pgTable("inquiry_statuses", {
  id: uuid("id").primaryKey().defaultRandom(),
  ...
  index("inquiry_statuses_listing_idx").on(t.listingId, t.finderId, t.listerId),
]);

export const conversationReports = pgTable("conversation_reports", {
  id: uuid("id").primaryKey().defaultRandom(),
